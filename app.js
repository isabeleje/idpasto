...
import ListosimpresionController from  './controllers/listosimpresion.js';
import PendientesactualizarController from  './controllers/pendientesactualizar.js';
import PendientesentregaController from  './controllers/pendientesentrega.js';
...
app.use('/api/listosimpresion', ListosimpresionController);
app.use('/api/pendientesactualizar', PendientesactualizarController);
app.use('/api/pendientesentrega', PendientesentregaController);
