...
class Listosimpresion extends BaseModel {
	static init() {
		return super.init(
			{
				...
				fotografia: { type:Sequelize.STRING  ,defaultValue: Sequelize.literal('DEFAULT') }
			}, 
			{ 
				sequelize,
				
				tableName: "listosimpresion",
				modelName: "listosimpresion",
			}
		);
	}
...
Listosimpresion.init();
export default Listosimpresion;
